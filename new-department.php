...
$departments = []; // Initialize departments array to avoid undefined variable warning
...
<head>
  ...
  <style>
    ...
    .content {
      margin-left: 0; /* Adjust to start from the left */
      padding: 70px; /* Optional: Add padding for content */
    }
  </style>
</head>
